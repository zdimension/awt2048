...
public class JeuCanvasBouton
{
     ...
     */
    JeuCanvasBouton(String text, Point position, Dimension size, Component parent, Runnable handler)
    {
        this.text = text;
     ...
     */
    void setButtonInfo(MouseEvent ev, boolean released)
    {
        var old = hover;
        var old2 = down;
        ...
        if (!hover || released)
            ...
            down = ev.getButton() == MouseEvent.BUTTON1;
